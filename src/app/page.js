...
const App = () => {
  return (
    <div className="bg-[#272c31] h-[100vh] flex gap-10 px-10 py-20">
      <div className="empty-box w-[50%] bg-[#565758] rounded-2xl"></div>
      <div className="main w-[50%] flex flex-col gap-4 ">
        <div className="about bg-[#32383e] rounded-2xl flex flex-col items-center  h-[50%] shadow-xl shadow-slate-900">
          <div className="buttons bg-black flex gap-4 mt-4 p-2 rounded-2xl ">
            <button className="focus:bg-zinc-700 px-7 py-1 rounded-xl text-lg text-white text-bold shadow-xl shadow-gray-950 ">
              About me
            </button>
          ...
          <div className="text flex flex-col gap-4 py-5">
            <div className="hello border-r-8 border-[#7b7d7e] mx-4 ">
              <h1 className="text-gray-400 text-lg px-12 ">
                Hello! I’m Dave, your sales rep here from Salesforce. I’ve been
                working at this awesome company for 3 years now.
              </h1>
            </div>
            <div>
              <h1 className="text-gray-400 text-lg px-16 ">
        ...
        <div className="image bg-[#32383e] rounded-2xl h-[50%] shadow-xl shadow-slate-900">
          <div className="gallery flex items-center  justify-between my-3 mx-14">
